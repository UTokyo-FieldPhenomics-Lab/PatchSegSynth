...
def get_arguments():
    ...
    parser.add_argument('--project_name', type=str, default='patch_level_hybrid_5x', help='Project name for outputs')
    
    ## Dataset 1, model will be trained on dataset 1 and 2 together
    parser.add_argument('--train_images_dir', type=str, default='../WE3DS_DATASET/Train/images', help='Directory for training images')
    parser.add_argument('--train_segmentations_dir', type=str, default='../WE3DS_DATASET/Train/annotations', help='Directory for training segmentations')

    ## Dataset 2
    parser.add_argument('--train_images_dir2', type=str, default='../WE3DS_DATASET/Synthetic/scenes_10x_old/images', help='Directory for training images')
    parser.add_argument('--train_segmentations_dir2', type=str, default='../WE3DS_DATASET/Synthetic/scenes_10x_old/annotations', help='Directory for training segmentations')
...
if __name__ == "__main__":
    ...
    train_dataset = WE3DSDataset(args.train_images_dir, args.train_segmentations_dir, transform=transform_train, train=True, \
                                 images_dir2=args.train_images_dir2, segmentations_dir2=args.train_segmentations_dir2)
